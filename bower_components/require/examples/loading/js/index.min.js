(function(index, modules, paths, Buffer, process, global) {
    ...
    function require(path) {
        ...
        if (!module) {
            ...
            tmp[0].call(module, require, module.exports, module.filename, module.dirname, module, process, Buffer, global);
        }
    ...
    "./index.js", [
        ...
        EventEmitter.prototype.on = EventEmitter.prototype.addListener = function(type, listener, ctx) {
            var events = this._events;

            (events[type] || (events[type] = [])).push(new EventObject(listener, ctx || this));
        ...
        EventEmitter.prototype.off = EventEmitter.prototype.removeListener = function(type, listener, ctx) {
